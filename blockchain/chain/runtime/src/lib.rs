...
use frame_support::{
	...
	parameter_types,
	RuntimeDebug,
	traits::{Contains, KeyOwnerProofSystem, LockIdentifier, OnRuntimeUpgrade}, weights::{constants::WEIGHT_PER_MILLIS, Weight},
};
...
use runtime_common::{
	auctions, BlockHashCount, BlockLength, BlockWeights, claims, crowdloan, CurrencyToVote,
	impls::DealWithFees, OffchainSolutionLengthLimit, OffchainSolutionWeightLimit, paras_registrar,
	RocksDbWeight, slots, SlowAdjustingFeeUpdate,
};
...
use sp_runtime::{
	...
	impl_opaque_keys,
	KeyTypeId,
	Perbill, Percent, Permill, traits::{
...
pub const VERSION: RuntimeVersion = RuntimeVersion {
	spec_name: create_runtime_str!("catena"),
	impl_name: create_runtime_str!("peter-catena"),
	authoring_version: 0,
	spec_version: 2,
	impl_version: 1,
